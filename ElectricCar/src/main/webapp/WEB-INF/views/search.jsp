	...
	<section class="condition-section bg-black">
		<div class="container">
						...
						<div class="card-body text-center">
							...
							<div class="btn-group col-9">
								<div class="input-group-prepend">
									<label class="input-group-text" for="inputGroupSelect01">브랜드
										1</label>
								</div>
								...
								<div style="display: flex;">
									<div class="input-group mb-3 text-center"
										...
										<input id="minprice" name="minprice" type="number"
											...
											placeholder="만 원" required /> <span
											style="padding: 5px; margin-left: 5px; margin-right: 0;">
											~ </span>
										<div class="input-group-prepend" style="margin-left: 1.0rem;">
				...
				<div class="col-md-6 mb-3 mb-md-0">
					<div class="card py-4 h-100" style="border-radius: 2rem;">
						<div class="card-body text-center">
							...
							<div class="btn-group col-9">
								<div class="input-group-prepend">
									<label class="input-group-text" for="inputGroupSelect01">도/광역시
										</label>
								</div>
			...
			<div class="text-center"
				style="padding-top: 5%; padding-bottom: 3rem;">
				<a class="btn btn-primary js-scroll-trigger" id="result_btn"
					onclick="findResult_id()" href="#result_car">Pick your car NOW</a>
			</div>
		</div>
	</section>

	<div class="text-center"
		style="padding-top: 3rem%; padding-bottom: 3rem;"></div>
