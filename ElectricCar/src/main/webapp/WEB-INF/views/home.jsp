...
<html lang="en">
    ...
    <body id="page-top">
	             	...
	             	<div class="row">      
		                <div class="col-lg-12 mx-auto text-right">
		                    ...
		                    <div style="text-align: left; margin : 10px;">
			                    <a class="js-scroll-trigger" style="margin-top:10px;" onclick = "location.href='./search'"> &gt; GO</a><br>
        ...
        <div class="container">
       	 Copyright &copy; Pick Car Chu ~ &hearts; 2021-1 Database System Term Project <br>
       	 <a href="./CreatorInfo">정보문 홍승훈 김예진 양지후</a>
       	</div>
        </footer>
        <!-- Bootstrap core JS-->
